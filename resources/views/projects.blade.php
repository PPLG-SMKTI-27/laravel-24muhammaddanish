...
<body>
        ...
        <div class="container">
            <nav>
                ...
                <div class="nav-links" id="navLinks">
                    ...
                    <a href="/about#experience">Pengalaman</a>
                    <a href="/about#skills">Skill</a>
                    <a href="/projects" style="color: var(--primary);">Halaman Proyek <i class="fas fa-external-link-alt" style="font-size: 0.8rem;"></i></a>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p>Hubungi saya untuk diskusi tentang proyek baru, kesempatan kolaborasi, atau hanya sekedar menjalin koneksi profesional. Saya selalu terbuka untuk peluang yang menarik!</p>
            
            <div class="cta-buttons">
                <a href="about" class="btn">
                    <i class="fas fa-envelope"></i> Hubungi Saya
                </a>
                <a href="about#skills" class="btn btn-outline">
